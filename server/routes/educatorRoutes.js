...
const {updateRoleToEducator, addCourse,deleteCourse, getEducatorCourses, getEnrolledStudentsData, educatorDashboardData }= require('../controllers/educatorController.js');
